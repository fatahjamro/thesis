...
Where $I$ is the identity operator $(I: H \rightarrow H)$. Unitary operator $U$ is \textit{Surjective} and it preserves the inner product of the Hilbert space, $H$. We can write it as for all vectors $A$ and $B$ in $H$ we get: $$\langle UA, UB \rangle_{H} = \langle A, B \rangle_{H}$$
